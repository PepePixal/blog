...
// windos. convierte la función string_to_slug en una función global
window.string_to_slug = function(str, querySelector){
    ...
    // Asignar el slug generado al value de campo de entrada correspondiente,
    //en nuestro caso el input con name="slug"
