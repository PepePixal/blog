<x-layouts.admin>
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn btn-blue text-sm">
            Nuevo Usuario
        </a>
    </div>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-green">
                                Editar
                            </a>
                        </td>
                        <td class="px-6 py-4">
    ...
    {{-- links de paginación, obtenidos de la variable $users que viene de la ruta admin.users.index --}}   
    <div class="mt-4">
        {{ $users->links() }}
    </div>
